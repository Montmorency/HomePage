...
\section{Pettifor's Maps and The Structural Energy Difference Theorem}
...
We then impose the requirement that $U_{\rep}(R^{(II)})$ is chosen 
equal to the repulsive energy of structure $I$ at its equilibrium: $U^{(I)}_{\rep}(R^{(I)}_0)$.
...
This theorem has been used extensively by Pettifor and his co-workers who were able to 
...
%The structure maps have found industrial application in addressing the technical challenges encountered 
