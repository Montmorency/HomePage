...
of molecular compounds \cite{pauling28}. Pauling's publication was a year before
Felix Bloch published his work on electrons in crystals \cite{bloch28}. The
way these two perspectives, local and extended, are applied and rationalized 
are the distinguishing feature in entire fields and sub-fields of physics 
and chemistry.

Wannier succeeded in obtaining a set of functions
from the set of Bloch waves which were localized in each unit cell
of a crystal and orthogonal to the wavefunctions in each of its
neighbouring cells \cite{wannier37, wannier62}. This work, Wannier
notes, stems from Wigner's suggestion that, ``... there ought to be
a way to reconcile the local and the band concept for electrons, and that
such a reconciliation would probably be useful in understanding the
spectra of insultators." The practical consequence of his formalism was
...
A unified treatment of each of these perspectives based on group theory 
