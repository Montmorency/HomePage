...
\]
%
The subscript represents the iteration number and the superscript 
represents `the stage of mixing'. 
...
We may exploit Broyden's technique which allows us to build an estimate of $\chi$
...
In practice without any mixing bottom chain, with no density mixing, may never stabilize. 
Working out the optimal way of approximating and storing $\chi$ played an important role
...
projections $\hat{P}_{n}$ and $\hat{P}_{V}$ which act on the density and the potential. 
The hope is that these projection operations will preserve as much of the 
exactness of the original sequence as possible. If we can project the ab initio density 
