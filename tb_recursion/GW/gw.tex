...
block notation $n\k$ to a single index $n$, and then reintroduce the full Bloch notation when
...
a prescription for obtaining a set of wavefunctions, and eigenvalues, describing
the ground-state density. The various approximations to the exchange correlation 
functional commonly used in applications of Kohn-Sham DFT were discussed: the LDA, 
...
in the final section by sketching out the type of integrals that would 
...
the exchange and correlation energies systematically is discussed
in Section~\ref{sec:gwpert}. By mapping these operators onto matrix elements and being selective  about which experimentally accessible quantities we wish to compute 
