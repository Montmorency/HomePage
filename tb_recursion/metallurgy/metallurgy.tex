...
Often the first three lattices encountered by students of metallurgy will be
FCC, HCP, and BCC.
...
the problem in Ref.~\cite{altmann57}. 

One of the earliest applications of the recursion method 
the sorting of the Lave Phases \cite{haydocklaves75,johannes76}.
...
relating to thermal desorption.
