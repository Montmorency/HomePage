...
\begin{figure}
\begin{center}
\includegraphics[scale=1.0]{./invariance/tbresponse.pdf}
\caption{Pictorial representation of the terms and sites described by Eq.~\ref{eq:tbdynmat}.
On the left atoms $b,d$ and corresponding orbitals, $d, q$. On the right are two unit cells
of BCC crystal with the nearest neighbours to the 0th atom extended out to its sixth nearest
...
If we may be permitted a small discursion into metaphor the difference 
between the scalar recursion and the block recursion method is 
