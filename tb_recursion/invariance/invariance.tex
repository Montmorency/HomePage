...
In short the method is applicable 
...
of the blackbody spectrum determined by Weyl and Von Laue; i.e.,
the local statistics of the radiation system, that is the 

is formally insensitive to the boundary 
conditions of the system so long as the boundary is more than a few
wavelengths . This results from the destructive interference of the cavity modes 
outside the small  region of space under consideration. 
We shall present the gist of Von Laue's argument shortly.
It is this theorem which will allow us to construct
...
In particular the work of Hermann Weyl, a student of Hilbert and his school 
at G\"ottingen,and Max von Laue. 
Historically these results were arrived at shortly after Plank and Einstein's 
work in radiation theory and special relativity had been established.
In Von Laue's case his work was contemporaneous with the 
nobel winning discovery of X-ray diffraction
by crystals. A little historical digression is merited here.

Ewald, who made important contributions to X-ray crystallography,
has authored a biographical sketch of Von Laue\cite{ewald60}. 
In discussions with other physcists in Germany around 1910 there seemed to be a consensus
that the thermal motion of atoms would obscure any clear diffraction resonances indicating
crystalline structure. Von Laue was of the opinion that the experiment should be tried anyway, 
and the experimental work was carried out by W. Fridrich and P Knipping.
...
In any macroscopic material system there is an enormous number of degrees of freedom.
...
in a material system. For example for an hydrogen atom the density of
states will have a delta function located at each of the permissible energy levels
of the hydrogen atom the discrete values for $E_{n}$ can then 
be computed to good accuracy fairly easily using analytic techniques. 
In a solid, as one might expect, involving many atoms arranged in complex patterns 
the spectrum becomes more complicated; this complexity ensures continuing work 
...
an additional spatial variable $\r$. 
If we can demonstrate that the sum in Eq.~\ref{eq:ldos} evaluated at 
the point $\r$ is insensitive to changes in the systems more than 
a few wavelengths 
...
was a student of Hilbert's and was extremely well versed in the 
...
Weyl's paper is also the more general. The title translates as,
`Asymptotic distribution law 
...
translating as `radiation of a cavity with a small hole in it'. 
...
At this point we wish to stress that Weyl's asymptotic relations 
...
intuition. By making an analogy with the resolving power of a lens
Von Laue considers the . He sets up the coordinate system pictured
in Figs.~\ref{fig:vonlaue} modeled on a suggestion of Debye 
(see Fig.~\ref{fig:debye} for the original \cite{debye1908}).
%
\begin{figure}
...
phenomena in a small region of space for a small spectral width, they
are able to show that for large cavity sizes the cavity radiation intereferes 
destructively outside these regions.
The formulations resemble more closely what have come to be called
windowed Fourier transforms and wavelets. These constructions obtain a better optimized
description of a wave pattern in terms of the decay of the signal in both 
real and reciprocal space.

Whether one favours Weyl's approach or Von Laue's \textit{the essential point is that 
...
properties of the electronic, elastic, and vibrational waves in materials
