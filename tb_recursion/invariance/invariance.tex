...
that comes up for discussion now and then. This book is  
...
Some skeptics may object to the term `real space' Afterall, what other type of space is there? 
...
so prevalent that the continuity of history was becoming dangerously 
fractured and reality was becoming intolerably improbable. As a result an organization
was founded to campaign for restrictions on time travel. A similar issue could be
argued to have developed in materials science.  
...
In some sense these notes are part of a manifesto for an organization which 
advocates the use of `real space methods'.

There is a good reason for the ubiquitiy of reciprocal space techniques:
...
can be indexed by a wavenumber $\lambda_n$, e.g. $sin\lambda_{n} x$, which
has units of inverse length,that is a reciprocal length, whence, reciprocal space. 
...
Reciprocal space techniques have proved essential in other branches of science. For instance
James Watson recalls a note that Francis Crick wrote entitled `Fourier Transforms 
for Birdwatchers' meant to acquaint biologists with the essential points of reciprocal space.
In reciprocal space the characteristic diffraction spots give indications of the
symmetry groups
...
The periodicity of the atomic lattice means the electronic waves in crystals experience 
a similarly periodic potential. Bl\"ochs theorem allows us to enumerate and solve for the 
eigenvalues of the electronic system in reciprocal space as well. 
...
There is also one particularly awkward and reasonable question: 
what happens if perfect periodicity is disrupted?

Let us now adopt the perspective of a pragmatic chemist. The pragmatic chemist has the periodic table which
...
next to each other. For small molecules the hope is this approach will lead somewhere.
As the size of the system increases some account must be made for the diffusion of the electrons
throughout the system. It turns out accounting for this diffusion is essential to 
obtain an accurate quantitative and qualitative picture of the 
physics. 

What we require is an intermediate representation between a strictly localized
...
Just such a viewpoint is developed comprehensively in Vol.~35 
and this chapter is purely a summary of the work developed there.
By the end of this chapter 
the reader should have some sense of the theory and the technique for calculating
materials properties in real space.
...
As it turns out the recursion method
...
This analogy has been developed by Friedel \cite{friedel54} where
