...
\subsection{Surface Electronic Structure and Orbital Peeling}
...
to demonstrate some of the typical techniques required to perform 
surface type calculations.
The example treats the problem of the interaction of adatoms on a 
surface, i.e. adatoms interacting via the metallic substrate a problem
treated in Ref.~\cite{einstein73}. Most of this section is 
based on the work presented in Ref.~\cite{burke76}. 
...
First the two atoms are placed at a sufficient
...
The lack of a procedure for a choice of the tight binding 
