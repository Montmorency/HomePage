...
chains in Ref.~\cite{coulson39,coulson47}. It is a good exercise to compare
...
been that they are orthogonal. Unfortunately
spherical harmonics centered on neighbouring atoms
...
In the case of Wannier functions this procedure will be discussed
in Chap.\ref{chap:wannier}.
It is possible in another rotated basis the Hamiltonian will gain a more 
complicated form with contributions from more distant atoms.
...
may require a non-orthogonal basis set but for intuition
...
%The problem of non-orthogonality of basis vectors 
%is closely connected to the Block Recursion method 
%which we will come to in the next section. 
%But the general ideas underlying non-orthogonal 
%recursion calculations should be treated first. 
