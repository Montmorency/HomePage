...
The (anticipated)\footnote{The paper explicitly says the sum in Eq. could be performed with the
help of computers:"The possibility is not excluded that eventually ways will be found to do this work by means of high-speed computers, but
it will certainly be quite out of the question without such help. "} 
development of computers means the secular equations  can be solved at arbitrary $\k$ points.
