...
%What is the reason for this delayed maturity? 
%Ehrenreich suggests an historical one. That is 
%the human study and manipulation of materials has traditionally
%been considered as a craft. 
...
Perhaps the worker possesses a set of precision tools or 
established practices. However the process remains fundamentally informed by 
the individual choices of the craftsman. These choices are necessarily personal.
It is in the course of making these choices where some aspect of the craftsmen's 
...
notes and all subsequent discussion is formulated with recursion techniques in mind.

After spending some (considerable) time on invariance and recursion theory 
the standard presentation of Density Functional Theory is made along 
...
provide the local interaction parameters required in recursion formulations.
...
Chapter~\ref{chap:gw} introduces a more advanced 
