...
\begin{figure}
\begin{center}
\includegraphics[scale=1.0]{./intro/coulsonh2.png}
...
%However his method of tackling the problems in his chosen field by
...
%Turing's ideal computing machine, a black box, which 
%could advance or rewind a long
...
The journey from Turing's idealized machine to a physical machine capable of manipulating
...
%As Turing noted the important point about
...
The constant and transforming development of computers
...
Also on the side of technique is the choice of representation for your electrons.
...
%functional theory. 
%However these methods are suitable for crystalline systems with periodicity and can be pushed 
...
Without wishing to get bogged down in the technical details of Chapter~\ref{chap:gw}
...
The present paramterization of this function results in a set of
unremarkable curves displayed in Fig.~\ref{fig:ldapz}.
However, the practical consequence of these curves is they enables the
...
Just how creditable this approach is brings us back to Ehrenreich's third point.
...
%In this work we take a strong stance against reparameterizing the simplest exchange-correlation functional
%in order to improve the agreement of peoples calculations with 
%experimental data. The extent to which this reparameterization is helpful is debateable. 
...
To conclude this section we refer the reader to Fig.~\ref{fig:loctoglob}.
%
\begin{figure}
...
In Chapter~\ref{chap:metallurgy} we turn to applications and
