...
related methods to obtain energy 
bounds on the order of a few meV. Physicists are interested in lasers, 
Ising and Hubbard models, and the 
general positions of resonances and asymptotes in very cold materials 
and won't be discussed further. The connection between band
theory and the chemist's molecular orbital picture is developed in
Ref.~\cite{hoffman87}.
