...
For instance many mechanical properties of materials can be describe by a scalar, like Youngs modulus, poisson ratios, 
or small tensors to describe the elasticity. Even some electronic properties can be described using a single number
...
they are and what they have enabled. In the
...
wishes to ``compute groundstate properties such as cohesive energies, interatomic forces, 
...
Table~\ref{tab:foundation} is biased towards a "plane wave" conception of electronic structure. 
...
the valence electrons of atoms and chemical elements are grouped together in the table 
by their valency. 
...
which can be used to compute the properties of materials that may interest engineers.
