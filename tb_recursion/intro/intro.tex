...
for each compound in a series, etc..
...
Engineers are accustomed to working with the Young's moduli and elastic tensors, dielectric constants, 
all quantities which characterize the properties of a system made up of many tiny degrees of freedom.
The point at which quantum dynamical variables merge into macroscopic parameters should be incorporated
into a satisfactory theory.
