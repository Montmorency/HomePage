...
C      CALL RECSUM(A,B2,15,LL,NP,AA,BB2,EPS,TABS,375)
      CALL RECSUM(A,B2,15,11,NP,AA,BB2,EPS,TABS,375)

      WRITE(6,2)

      WRITE(6,12)LLIN

CH     WRITE(6,2)(AA(J),BB2(J),J=1,LL)
      WRITE(6,2)(AA(J),BB2(J),J=1,LLIN)
