...
C  NED IS THE DIMENSION OF ARRAYS IW(LIST OF INTERACTION TYPES),VEC AND EE
...
C In line with what adrian was saying
C     B2(1)=2.0
      B2(1)=1.0
...
C Only if we have multiple hydrogens.
C      IF(I.EQ.J)GOTO 4
...
C      WRITE(6,*) "Inverted interaction"
