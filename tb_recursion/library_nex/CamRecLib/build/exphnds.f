      ...
      DIMENSION A(50),B2(50),COORD(3,6),ITYP(6),TITLE(6)

      INTEGER*2 NN

      COMMON /BLKHAM/DM(3,3,50),NDM

      COMMON /BLKMAP/NND,NNMX,NAT,NN(6,5)

      COMMON /BLKPAR/AA,BB(2),RTMASS(2),NON

      COMMON /BLKWFN/PSI(3,6),PMN(3,6)
...
14    FORMAT(20X,' ATOM',I5,' COORDINATE',I3,50(/20X,2E13.5))
      ...
      COMMON /BLKWFN/COORD(3,6),ITYP(6),JUNK(2,6)
