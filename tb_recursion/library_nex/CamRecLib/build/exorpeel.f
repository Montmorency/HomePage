      ...
      INTEGER*2 MM,NN,IZERO,IZP,IW,MEM

      DIMENSION CRD(3,100),VEC(3,60),IZP(100),MEM(3,15),IW(2,60)

     1,PSI(5,100),PMN(5,100),A(34),B2(34)
...
C     CALL OUT(6,1,1,IZP,IW,VEC,NED,NE,NAT,MM,NN,NNDIM,INTDIM,EE,NP)
