     ...
     1,IZERO(1500)
      ...
      EXTERNAL SLKODE,HOP,BCCLAM,EQUIV
...
C     CALL SETUP(CRD,3,NAT,EQUIV,NTYPE,IZP,MM,NN,NNDIM,NM,SLKODE,BCCPET
...
C  CONSTRUCT INITIAL WAVE FUNCTION NONZERO ON ATOM 5, 5, 5 AND
